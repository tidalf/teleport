...
func NewHandler(cfg Config, opts ...HandlerOption) (*RewritingHandler, error) {
	...
	// Web sessions
	// h.GET("/webapi/saml/metadata",h.sp)
...
// samlConsume send saml sp metadata
...
// samlMetadata send sp metadata and can be used directly from the idp
...
// MakeRedirectAuthenticationRequest send sp metadata and can be used directly from the idp
